MAPSTYLE_JSON = '''
{
  ...
  "sources": {
    "ne2_shaded": {
      ...
      "tileSize": 256,
      "tiles": [
        "[URL]/proxy/tiles/natural_earth/ne2sr/{z}/{x}/{y}.png"
      ],
      "type": "raster"
    },
    "openmaptiles": {
      "type": "vector",
      "url": "[URL]/proxy/tiles/planet"
    }
  },
  "sprite": "[URL]/proxy/tiles/sprites/ofm_f384/ofm",
  "glyphs": "[URL]/proxy/tiles/fonts/{fontstack}/{range}.pbf",
  "layers": [
    {
      "id": "background",
      "type": "background",
      "paint": {"background-color": "rgba(251, 49, 49, 1)"}
    },
    {
      "id": "park",
      "type": "fill",
      ...
      "paint": {"fill-color": "rgba(255, 73, 73, 1)"}
    },
    {
      "id": "water",
      "type": "fill",
      ...
      "paint": {"fill-antialias": true, "fill-color": "rgba(71, 124, 140, 1)"}
    },
    {
    ...
    },
    {
      ...
      "paint": {"line-color": "rgba(71, 124, 140, 1)"}
    },
    {
      "id": "building",
      "type": "fill",
    ...
    },
    {
      ...
      "paint": {"line-color": "rgba(197, 0, 0, 0.74)", "line-width": 2}
    },
    {
    ...
    },
    {
      ...
      "paint": {
        "line-color": "hsl(0,0%,70%)",
        "line-opacity": ["interpolate", ["linear"], ["zoom"], 0, 0.4, 4, 1],
        "line-width": ["interpolate", ["linear"], ["zoom"], 3, 1, 5, 6.2, 12, 3]
      }
    },
    {
